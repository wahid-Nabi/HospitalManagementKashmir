<?php $translations = array (
  ...
  array (
    ...
    'confirmSelection' => __( 'Confirm Selection', 'simply-schedule-appointments' ),
  ),
  'pageTitles' => 
  array (
    'book' => __( 'Enter your contact information', 'simply-schedule-appointments' ),
    'customerInformation' => __( 'Enter your contact information', 'simply-schedule-appointments' ),
    'Booked' => __( 'Appointment booked', 'simply-schedule-appointments' ),
    'confirmation' => __( 'Appointment booked', 'simply-schedule-appointments' ),
    ...
    'appointmentType' => __( 'Select an appointment type', 'simply-schedule-appointments' ),
    'view' => __( 'View your appointment', 'simply-schedule-appointments' ),
    'express' => __( 'Select a date and time', 'simply-schedule-appointments' ),
  ),
  'booking' => 
  array (
    ...
    'invitationHasBeenSent' => __( 'A calendar invitation has been sent to your email address', 'simply-schedule-appointments' ),
    ...
    'redirecting' => __( 'Please wait while we redirect you', 'simply-schedule-appointments' ),
  ),
  'suggestFirstAvailable' => 
  array (
    'next' => __( 'Next available appointment', 'simply-schedule-appointments' ),
    'confirm' => __( 'Confirm Appointment Time', 'simply-schedule-appointments' ),
    'pickAnother' => __( 'Or, pick another time', 'simply-schedule-appointments' ),
  ),
  'change' => 
  array (
    ...
    'reschedulingNote' => __( 'Rescheduling Note', 'simply-schedule-appointments' ),
  ...
  'reschedulingDialog' => 
  array (
    'title' => __( 'Would you like to leave a rescheduling note?', 'simply-schedule-appointments' ),
    'text' => __( 'This appointment will be rescheduled to', 'simply-schedule-appointments' ),
    'textfieldLabel' => __( 'Rescheduling Note', 'simply-schedule-appointments' ),
    ...
    'review' => 
    array (
      'none' => __( 'None', 'simply-schedule-appointments' ),
      'screenReader' => 
      array (
        'edit' => __( 'Edit rescheduling note', 'simply-schedule-appointments' ),
        'add' => __( 'Add rescheduling note', 'simply-schedule-appointments' ),
      ),
    ),
  ),
  'errors' => 
  array (
    ...
    'fieldRequired' => __( 'Field required.', 'simply-schedule-appointments' ),
    ...
    'pickNewDate' => __( 'Pick a new date', 'simply-schedule-appointments' ),
  ...
  array (
    ...
    'loading' => __( 'Loading payment method', 'simply-schedule-appointments' ),
    ...
    array (
      ...
      'processing' => __( 'Processing your payment...', 'simply-schedule-appointments' ),
    ),
    'paypal' => 
    array (
      'bookAndPayLabel' => __( 'Confirm and Pay', 'simply-schedule-appointments' ),
    ...
    'paymentDue' => __( 'Payment Due:', 'simply-schedule-appointments' ),
    'paymentFailed' => __( 'Unable to process payment. Please try again.', 'simply-schedule-appointments' ),
    'paymentDelayHeader' => __( 'Things are taking longer than expected', 'simply-schedule-appointments' ),
    ...
    'stripeDelayText' => __( 'Stripe is taking a little longer than usual to process your payment. Don\'t worry - we\'ll hold your appointment time for you. This usually resolves within a few minutes, or in rare cases, a few hours. Once your payment is processed, you\'ll receive an email confirmation of this appointment. If you don\'t receive that, please get in touch.', 'simply-schedule-appointments' ),
  ),
  'resources' => 
  array (
    'selectResource' => __( 'Select a Resource', 'simply-schedule-appointments' ),
    'any' => __( 'Any', 'simply-schedule-appointments' ),
    'toBeAssigned' => __( 'To be assigned', 'simply-schedule-appointments' ),
  ),
  'teamMembers' => 
  array (
    'selectTeamMember' => __( 'Team Member', 'simply-schedule-appointments' ),
    'any' => __( 'Any', 'simply-schedule-appointments' ),
    'toBeAssigned' => __( 'To be assigned', 'simply-schedule-appointments' ),
    'selectedMember' => __( 'Team Member: ', 'simply-schedule-appointments' ),
  ),
  'inputs' => 
  array (
    'phone' => 
    array (
      'placeholder' => __( 'Enter a phone number', 'simply-schedule-appointments' ),
    ),
  ),
);